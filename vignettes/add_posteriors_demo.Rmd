...
testit::assert(RBeast::is_posterior(wiritttea::get_posterior(file = read_file(filename), sti = 1, ai = 1, pi = 1)))
testit::assert(RBeast::is_posterior(wiritttea::get_posterior(file = read_file(filename), sti = 1, ai = 1, pi = 2)))
testit::assert(RBeast::is_posterior(wiritttea::get_posterior(file = read_file(filename), sti = 2, ai = 1, pi = 1)))
testit::assert(RBeast::is_posterior(wiritttea::get_posterior(file = read_file(filename), sti = 2, ai = 1, pi = 2)))

phylogenies_1 <- wiritttea::get_posterior(file = read_file(filename), sti = 1, ai = 1, pi = 1)$trees
phylogenies_2 <- wiritttea::get_posterior(file = read_file(filename), sti = 1, ai = 1, pi = 2)$trees
phylogenies_3 <- wiritttea::get_posterior(file = read_file(filename), sti = 2, ai = 1, pi = 1)$trees
phylogenies_4 <- wiritttea::get_posterior(file = read_file(filename), sti = 2, ai = 1, pi = 2)$trees
