...
df_n_taxa <- wiritttea::collect_files_n_taxa(filenames = sub_filenames)
write.csv(df_n_taxa, "~/n_taxa.csv")
```
...
wiritttea::collect_files_n_taxa(filenames = sub_filenames)
Rprof(NULL)
...
```{r}
df_parameters <- wiritttea::read_collected_parameters()
```
