context("create_figure_error_alignment_length_mean")
...
test_that("works", {
  ...
  filename <- tempfile(pattern = "figure_error_alignment_length_mean_",
    fileext = ".svg")

  testthat::expect_false(file.exists(filename))
  create_figure_error_alignment_length_mean(
