...
a2i <- function(
  ...
  i <- 1 + (sti - 1) + ((ai - 1) * nstpist)  # nolint removing '((' reduces readbility
  return(i)
}
...
p2i <- function(
  ...
  i <- 1 + (sti - 1) +
    ((ai - 1) * nstpist) +       # nolint removing '((' reduces readbility
    ((pi - 1) * nstpist * napst) # nolint removing '((' reduces readbility
  return(i)
}
